...
fun GameResultSection(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = winnerText,
                style = BattleRopeTheme.typography.headingXLSB.copy(fontSize = 48.sp),
...
private fun StatRow(
    ...
    Row(
        ...
        Text(
            text = "$label:",
            style = BattleRopeTheme.typography.bodyMM,
            color = BattleRopeTheme.colors.textSecondary,
        )
        Text(
            text = value,
            style = BattleRopeTheme.typography.bodyMSB,
            color = BattleRopeTheme.colors.textPrimary,
        )
    }
}
